...
Manage HubSpot CRM data with AI agents via MCP.

 `hubspot` `crm` `sales-automation` `mcp` `ai-agents`

---

## What is this?

Open this repo in **Amp**, **Cursor**, or **VS Code** and your AI agent can immediately manage HubSpot — no SDK to install, no dependencies. The [Synter MCP server](https://github.com/Synter-Media-AI/mcp-server) is already configured.
...
> Sync contacts to a Google Ads audience

> Pull email engagement metrics

> Export a list for Meta Custom Audiences
